...
<body>
    ...
    <form action="prosesedit.php?id=<?= $data['id_pengaduan']?>" method="POST" enctype="multipart/form-data">
    <div class="container">
        <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <textarea class="form-control" id="exampleFormControlTextarea1" name="isi_laporan" rows="3" value="<?php echo $data['isi_laporan']?>" required></textarea>
    </div>
